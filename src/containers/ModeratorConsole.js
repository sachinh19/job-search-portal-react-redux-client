                    ...
                    <div className="container wbdv-options-container">
                        <ul className="list-group">
                            <li className="list-group-item wbdv-options">
                                <Link to={`/moderatorConsole/jobs`} className="wbdv-options-item">View All Jobs</Link>
                            </li>
                            <li className="list-group-item wbdv-options">
                                <Link to={`/moderatorConsole/companies`} className="wbdv-options-item">View All Companies</Link>
                            </li>
                        </ul>
                    </div>
                </div>
